...
def normalise_input(user_input):
    ...
    normalise_string = remove_punct(user_input).lower()
    normalise_string = normalise_string.strip()
    normalise_string = normalise_string.split()
    normalise_string = filter_words(normalise_string,skip_words)
    #no_punct = remove_punct(user_input).lower()
    #user_input=filter_words(no_punct.split(),skip_words)
    
    #normalise_string[0] = normalise_string[0].replace("",",")

    return normalise_string
    # COMPLETE ME!
    #
